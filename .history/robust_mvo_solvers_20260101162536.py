...
def robust_mvo_general_unified(mu_hat, Sigma_hat, lam, epsilon, kappa, S_mu, P_shape):
    ...
    # B. Robust Penalty (Generalized): epsilon * || P(W + Z)P ||_F
    # This single line handles all 3 views depending on what P_shape you pass in.
    ...
    constraints = [
        cp.sum(w) == 1,
        w >= 0,
        Z >> 0,  # Z handles the worst-case PSD requirement
